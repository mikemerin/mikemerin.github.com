...
Success! We can continue this for the other letters as well:
...
Going into the script we just wanted to find a generic word character `\w` but once we found it we could then test it out.
