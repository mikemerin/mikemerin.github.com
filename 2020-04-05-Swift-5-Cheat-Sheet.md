---
layout: post
title:  "A Swift Cheat Sheet"
date:   2020-04-05 19:07:44 -0400
categories: Swift, iOS, tutorial
---
This is an abbreviated cheat sheet for Swift.I also have a [Javascript Cheat Sheet](https://mikemerin.github.io/Javascript-Cheat-Sheet/) and [Python Cheat Sheet](https://mikemerin.github.io/Python-Cheat-Sheet/) in the same fashion as this one if you're interested.

Datatypes | Interpolation | Type Conversion | ES6 | Arrow Functions | Callbacks | while
...
### Datatypes
```swift
let cannotBeChangedAfterThis = 0
var canBeChangedAndReassigned = 0
...
minusNum = -num //=> -5
minusMinusNum = -minusNum //=> 5
plusMinusNum = -minusNum //=> -5
...
var isThisAnswerNil: String?
var answer = isThisAnswerNil ?? defaultAnswer
